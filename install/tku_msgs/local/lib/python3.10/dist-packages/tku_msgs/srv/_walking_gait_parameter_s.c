...
bool tku_msgs__srv__walking_gait_parameter__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tku_msgs.srv._walking_gait_parameter.WalkingGaitParameter_Request", full_classname_dest, 65) == 0);
  }
  tku_msgs__srv__WalkingGaitParameter_Request * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of WalkingGaitParameter_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tku_msgs.srv._walking_gait_parameter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WalkingGaitParameter_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool tku_msgs__srv__walking_gait_parameter__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tku_msgs.srv._walking_gait_parameter.WalkingGaitParameter_Response", full_classname_dest, 66) == 0);
  }
  tku_msgs__srv__WalkingGaitParameter_Response * ros_message = _ros_message;
  {  // x_swing_range
    ...
    ros_message->x_swing_range = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // y_swing_range
    ...
    assert(PyFloat_Check(field));
    ros_message->y_swing_range = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // z_swing_range
    ...
    assert(PyFloat_Check(field));
    ros_message->z_swing_range = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // period_t
  ...
  {  // osc_lockrange
    ...
    assert(PyFloat_Check(field));
    ros_message->osc_lockrange = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // base_default_z
    ...
    assert(PyFloat_Check(field));
    ros_message->base_default_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // y_swing_shift
    ...
    assert(PyFloat_Check(field));
    ros_message->y_swing_shift = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // x_swing_com
    ...
    assert(PyFloat_Check(field));
    ros_message->x_swing_com = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // base_lift_z
    ...
    assert(PyFloat_Check(field));
    ros_message->base_lift_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // rightfoot_shift_z
    ...
    assert(PyFloat_Check(field));
    ros_message->rightfoot_shift_z = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // com_y_swing
    ...
    assert(PyFloat_Check(field));
    ros_message->com_y_swing = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // now_stand_height
    ...
    assert(PyFloat_Check(field));
    ros_message->now_stand_height = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // now_com_height
    ...
    assert(PyFloat_Check(field));
    ros_message->now_com_height = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // stand_balance
  ...
  {  // hip_roll
    ...
    assert(PyFloat_Check(field));
    ros_message->hip_roll = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // ankle_roll
    ...
    assert(PyFloat_Check(field));
    ros_message->ankle_roll = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of WalkingGaitParameter_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tku_msgs.srv._walking_gait_parameter");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WalkingGaitParameter_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
