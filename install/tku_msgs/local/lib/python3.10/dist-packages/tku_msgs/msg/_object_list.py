...
class Metaclass_ObjectList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tku_msgs.msg import ColorArray
            if ColorArray.__class__._TYPE_SUPPORT is None:
                ColorArray.__class__.__import_type_support__()
...
class ObjectList(metaclass=Metaclass_ObjectList):
    ...
    _fields_and_field_types = {
        'objectlist': 'sequence<tku_msgs/ColorArray>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['tku_msgs', 'msg'], 'ColorArray')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.objectlist = kwargs.get('objectlist', [])
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.objectlist != other.objectlist:
            return False
        return True
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, ColorArray) for v in value) and
                 True), \
                "The 'objectlist' field must be a set or sequence and each value of type 'ColorArray'"
