...
class SaveMotion(metaclass=Metaclass_SaveMotion):
    ...
    def __init__(self, **kwargs):
        ...
        self.motordata = array.array('i', kwargs.get('motordata', []))
    ...
    def motionstate(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'motionstate' field must be an integer in [-2147483648, 2147483647]"
    ...
    def savestate(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'savestate' field must be an integer in [-2147483648, 2147483647]"
    ...
    def motordata(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'i', \
                "The 'motordata' array.array() must have the type code of 'i'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, int) for v in value) and
                 all(val >= -2147483648 and val < 2147483648 for val in value)), \
                "The 'motordata' field must be a set or sequence and each value of type 'int' and each integer in [-2147483648, 2147483647]"
        self._motordata = array.array('i', value)
