...
bool tku_msgs__msg__color_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tku_msgs.msg._color_data.ColorData", full_classname_dest, 34) == 0);
  }
  tku_msgs__msg__ColorData * ros_message = _ros_message;
  {  // x
...
PyObject * tku_msgs__msg__color_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tku_msgs.msg._color_data");
