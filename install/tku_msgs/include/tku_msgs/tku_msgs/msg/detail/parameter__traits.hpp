...
#ifndef TKU_MSGS__MSG__DETAIL__PARAMETER__TRAITS_HPP_
#define TKU_MSGS__MSG__DETAIL__PARAMETER__TRAITS_HPP_
...
inline void to_yaml(
  const tku_msgs::msg::Parameter & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const tku_msgs::msg::Parameter & msg)
{
  return tku_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<tku_msgs::msg::Parameter>()
{
  return "tku_msgs::msg::Parameter";
}

template<>
inline const char * name<tku_msgs::msg::Parameter>()
{
  return "tku_msgs/msg/Parameter";
}

template<>
struct has_fixed_size<tku_msgs::msg::Parameter>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<tku_msgs::msg::Parameter>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<tku_msgs::msg::Parameter>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TKU_MSGS__MSG__DETAIL__PARAMETER__TRAITS_HPP_
