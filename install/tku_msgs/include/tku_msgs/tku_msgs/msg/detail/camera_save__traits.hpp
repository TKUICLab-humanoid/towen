...
#ifndef TKU_MSGS__MSG__DETAIL__CAMERA_SAVE__TRAITS_HPP_
#define TKU_MSGS__MSG__DETAIL__CAMERA_SAVE__TRAITS_HPP_
...
inline std::string to_yaml(const CameraSave & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const tku_msgs::msg::CameraSave & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const tku_msgs::msg::CameraSave & msg)
{
  return tku_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<tku_msgs::msg::CameraSave>()
{
  return "tku_msgs::msg::CameraSave";
}

template<>
inline const char * name<tku_msgs::msg::CameraSave>()
{
  return "tku_msgs/msg/CameraSave";
}

template<>
struct has_fixed_size<tku_msgs::msg::CameraSave>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<tku_msgs::msg::CameraSave>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<tku_msgs::msg::CameraSave>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TKU_MSGS__MSG__DETAIL__CAMERA_SAVE__TRAITS_HPP_
