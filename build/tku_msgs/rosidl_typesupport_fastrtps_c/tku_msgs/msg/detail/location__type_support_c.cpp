...
#include "tku_msgs/msg/detail/location__rosidl_typesupport_fastrtps_c.h"
...
using _Location__ros_msg_type = tku_msgs__msg__Location;
...
size_t get_serialized_size_tku_msgs__msg__Location(
  const void * untyped_ros_message,
...
static uint32_t _Location__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tku_msgs__msg__Location(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tku_msgs
size_t max_serialized_size_tku_msgs__msg__Location(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tku_msgs__msg__Location;
    is_plain =
      (
...
static size_t _Location__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tku_msgs__msg__Location(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tku_msgs, msg, Location)() {
