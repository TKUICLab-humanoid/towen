...
#include "tku_msgs/msg/detail/camera_save__rosidl_typesupport_fastrtps_c.h"
...
using _CameraSave__ros_msg_type = tku_msgs__msg__CameraSave;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CameraSave__ros_msg_type * ros_message = static_cast<const _CameraSave__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _CameraSave__ros_msg_type * ros_message = static_cast<_CameraSave__ros_msg_type *>(untyped_ros_message);
  // Field name: brightness
  {
    cdr >> ros_message->brightness;
  }
...
size_t get_serialized_size_tku_msgs__msg__CameraSave(
  const void * untyped_ros_message,
...
static uint32_t _CameraSave__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tku_msgs__msg__CameraSave(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tku_msgs
size_t max_serialized_size_tku_msgs__msg__CameraSave(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tku_msgs__msg__CameraSave;
    is_plain =
      (
...
static size_t _CameraSave__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tku_msgs__msg__CameraSave(
...
static message_type_support_callbacks_t __callbacks_CameraSave = {
  "tku_msgs::msg",
  "CameraSave",
...
static rosidl_message_type_support_t _CameraSave__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CameraSave,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tku_msgs, msg, CameraSave)() {
  return &_CameraSave__type_support;
}
