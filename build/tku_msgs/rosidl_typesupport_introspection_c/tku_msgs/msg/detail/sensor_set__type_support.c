...
static rosidl_typesupport_introspection_c__MessageMember tku_msgs__msg__SensorSet__rosidl_typesupport_introspection_c__SensorSet_message_member_array[1] = {
  {
    "reset",  // name
    ...
    offsetof(tku_msgs__msg__SensorSet, reset),  // bytes offset in struct
    NULL,  // default value
