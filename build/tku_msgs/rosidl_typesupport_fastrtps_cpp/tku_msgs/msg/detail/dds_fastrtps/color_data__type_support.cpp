...
#include "tku_msgs/msg/detail/color_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tku_msgs::msg::ColorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tku_msgs::msg::ColorData & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tku_msgs::msg::ColorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tku_msgs::msg::ColorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tku_msgs::msg::ColorData *>(
    untyped_ros_message);
...
static size_t _ColorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ColorData(full_bounded, is_plain, 0);
...
get_message_type_support_handle<tku_msgs::msg::ColorData>()
{
  return &tku_msgs::msg::typesupport_fastrtps_cpp::_ColorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, msg, ColorData)() {
  return &tku_msgs::msg::typesupport_fastrtps_cpp::_ColorData__handle;
}
