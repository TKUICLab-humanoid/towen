...
#include "tku_msgs/msg/detail/button_color_form__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tku_msgs::msg::ButtonColorForm & ros_message,
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tku_msgs
max_serialized_size_ButtonColorForm(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tku_msgs::msg::ButtonColorForm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tku_msgs::msg::ButtonColorForm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tku_msgs::msg::ButtonColorForm *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ButtonColorForm__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tku_msgs::msg::ButtonColorForm *>(
...
static size_t _ButtonColorForm__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ButtonColorForm(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ButtonColorForm__callbacks = {
  "tku_msgs::msg",
  "ButtonColorForm",
...
static rosidl_message_type_support_t _ButtonColorForm__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ButtonColorForm__callbacks,
...
{
  return &tku_msgs::msg::typesupport_fastrtps_cpp::_ButtonColorForm__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, msg, ButtonColorForm)() {
  return &tku_msgs::msg::typesupport_fastrtps_cpp::_ButtonColorForm__handle;
}
