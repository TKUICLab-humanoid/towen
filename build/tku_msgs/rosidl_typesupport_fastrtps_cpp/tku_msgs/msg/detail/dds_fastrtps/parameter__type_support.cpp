...
#include "tku_msgs/msg/detail/parameter__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tku_msgs::msg::Parameter & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tku_msgs::msg::Parameter & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tku_msgs::msg::Parameter;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tku_msgs::msg::Parameter *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tku_msgs::msg::Parameter *>(
    untyped_ros_message);
...
{
  return &tku_msgs::msg::typesupport_fastrtps_cpp::_Parameter__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, msg, Parameter)() {
  return &tku_msgs::msg::typesupport_fastrtps_cpp::_Parameter__handle;
}
