...
bool tku_msgs__msg__hsv_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tku_msgs.msg._hsv_value.HSVValue", full_classname_dest, 32) == 0);
  }
  tku_msgs__msg__HSVValue * ros_message = _ros_message;
  {  // hmin
...
PyObject * tku_msgs__msg__hsv_value__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tku_msgs.msg._hsv_value");
