...
bool tku_msgs__msg__camera_save__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tku_msgs.msg._camera_save.CameraSave", full_classname_dest, 36) == 0);
  }
  tku_msgs__msg__CameraSave * ros_message = _ros_message;
  {  // brightness
...
{
  /* NOTE(esteve): Call constructor of CameraSave */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tku_msgs.msg._camera_save");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraSave");
