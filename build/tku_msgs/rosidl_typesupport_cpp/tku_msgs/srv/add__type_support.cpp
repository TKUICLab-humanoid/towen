...
static const _Add_Request_type_support_symbol_names_t _Add_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, srv, Add_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, srv, Add_Request)),
  }
};
...
get_message_type_support_handle<tku_msgs::srv::Add_Request>()
{
  return &::tku_msgs::srv::rosidl_typesupport_cpp::Add_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tku_msgs, srv, Add_Request)() {
  return get_message_type_support_handle<tku_msgs::srv::Add_Request>();
}
...
static const _Add_Response_type_support_symbol_names_t _Add_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, srv, Add_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, srv, Add_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<tku_msgs::srv::Add_Response>()
{
  return &::tku_msgs::srv::rosidl_typesupport_cpp::Add_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tku_msgs, srv, Add_Response)() {
  return get_message_type_support_handle<tku_msgs::srv::Add_Response>();
}
...
static const _Add_type_support_symbol_names_t _Add_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, srv, Add)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, srv, Add)),
  }
};
...
get_service_type_support_handle<tku_msgs::srv::Add>()
{
  return &::tku_msgs::srv::rosidl_typesupport_cpp::Add_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, tku_msgs, srv, Add)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<tku_msgs::srv::Add>();
}
