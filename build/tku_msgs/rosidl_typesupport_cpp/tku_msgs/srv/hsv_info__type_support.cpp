...
static const _HSVInfo_Request_type_support_symbol_names_t _HSVInfo_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, srv, HSVInfo_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, srv, HSVInfo_Request)),
  }
};
...
{
  return &::tku_msgs::srv::rosidl_typesupport_cpp::HSVInfo_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tku_msgs, srv, HSVInfo_Request)() {
  return get_message_type_support_handle<tku_msgs::srv::HSVInfo_Request>();
}
...
static const _HSVInfo_Response_type_support_symbol_names_t _HSVInfo_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, srv, HSVInfo_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, srv, HSVInfo_Response)),
  }
};
...
{
  return &::tku_msgs::srv::rosidl_typesupport_cpp::HSVInfo_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tku_msgs, srv, HSVInfo_Response)() {
  return get_message_type_support_handle<tku_msgs::srv::HSVInfo_Response>();
}
...
static const _HSVInfo_type_support_symbol_names_t _HSVInfo_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tku_msgs, srv, HSVInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, srv, HSVInfo)),
  }
};
...
{
  return &::tku_msgs::srv::rosidl_typesupport_cpp::HSVInfo_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, tku_msgs, srv, HSVInfo)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<tku_msgs::srv::HSVInfo>();
}
