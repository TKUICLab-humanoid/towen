...
#ifndef TKU_MSGS__SRV__DETAIL__SAVE_HSV__FUNCTIONS_H_
#define TKU_MSGS__SRV__DETAIL__SAVE_HSV__FUNCTIONS_H_
...
/// Initialize srv/SaveHSV message.
/**
...
/// Create srv/SaveHSV message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tku_msgs__srv__SaveHSV_Request__init().
...
/// Destroy srv/SaveHSV message.
/**
 * It calls
 * tku_msgs__srv__SaveHSV_Request__fini()
...
/// Check for srv/SaveHSV message equality.
/**
...
/// Initialize array of srv/SaveHSV messages.
/**
...
/// Finalize array of srv/SaveHSV messages.
/**
 * It calls
 * tku_msgs__srv__SaveHSV_Request__fini()
...
/// Create array of srv/SaveHSV messages.
/**
 * It allocates the memory for the array and calls
 * tku_msgs__srv__SaveHSV_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SaveHSV messages.
/**
 * It calls
 * tku_msgs__srv__SaveHSV_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SaveHSV message array equality.
/**
...
/// Copy an array of srv/SaveHSV messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tku_msgs__srv__SaveHSV_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tku_msgs
...
/**
 * It calls
 * tku_msgs__srv__SaveHSV_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tku_msgs
...
/**
 * It allocates the memory for the array and calls
 * tku_msgs__srv__SaveHSV_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tku_msgs
...
/**
 * It calls
 * tku_msgs__srv__SaveHSV_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TKU_MSGS__SRV__DETAIL__SAVE_HSV__FUNCTIONS_H_
