...
#ifndef TKU_MSGS__SRV__DETAIL__ADD__FUNCTIONS_H_
#define TKU_MSGS__SRV__DETAIL__ADD__FUNCTIONS_H_
 ...
 * calls
 * tku_msgs__srv__Add_Request__init().
...
/**
 * It calls
 * tku_msgs__srv__Add_Request__fini()
 ...
 * tku_msgs__srv__Add_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tku_msgs__srv__Add_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tku_msgs__srv__Add_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tku_msgs
...
/**
 * It calls
 * tku_msgs__srv__Add_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tku_msgs
...
/**
 * It allocates the memory for the array and calls
 * tku_msgs__srv__Add_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tku_msgs
...
/**
 * It calls
 * tku_msgs__srv__Add_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TKU_MSGS__SRV__DETAIL__ADD__FUNCTIONS_H_
