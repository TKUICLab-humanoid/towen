...
{
  new (message_memory) tku_msgs::msg::Location(_init);
}

void Location_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tku_msgs::msg::Location *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Location_message_member_array[1] = {
  {
    ...
    offsetof(tku_msgs::msg::Location, data),  // bytes offset in struct
...
{
  return &::tku_msgs::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tku_msgs, msg, Location)() {
  return &::tku_msgs::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
