...
#ifndef ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__SRV__DETAIL__ARRAYS__TRAITS_HPP_
#define ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__SRV__DETAIL__ARRAYS__TRAITS_HPP_
...
#include "rosidl_typesupport_introspection_tests/msg/detail/constants__traits.hpp"
// Member 'defaults_values'
#include "rosidl_typesupport_introspection_tests/msg/detail/defaults__traits.hpp"
...
inline void to_yaml(
  const rosidl_typesupport_introspection_tests::srv::Arrays_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_typesupport_introspection_tests::srv::Arrays_Request & msg)
{
  return rosidl_typesupport_introspection_tests::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_typesupport_introspection_tests::srv::Arrays_Request>()
{
  return "rosidl_typesupport_introspection_tests::srv::Arrays_Request";
}

template<>
inline const char * name<rosidl_typesupport_introspection_tests::srv::Arrays_Request>()
{
  return "rosidl_typesupport_introspection_tests/srv/Arrays_Request";
}

template<>
struct has_fixed_size<rosidl_typesupport_introspection_tests::srv::Arrays_Request>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosidl_typesupport_introspection_tests::srv::Arrays_Request>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rosidl_typesupport_introspection_tests::srv::Arrays_Request>
  : std::true_type {};
...
[[deprecated("use rosidl_typesupport_introspection_tests::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const rosidl_typesupport_introspection_tests::srv::Arrays_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  rosidl_typesupport_introspection_tests::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use rosidl_typesupport_introspection_tests::srv::to_yaml() instead")]]
inline std::string to_yaml(const rosidl_typesupport_introspection_tests::srv::Arrays_Response & msg)
{
  return rosidl_typesupport_introspection_tests::srv::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_typesupport_introspection_tests::srv::Arrays_Response>()
{
  return "rosidl_typesupport_introspection_tests::srv::Arrays_Response";
}

template<>
inline const char * name<rosidl_typesupport_introspection_tests::srv::Arrays_Response>()
{
  return "rosidl_typesupport_introspection_tests/srv/Arrays_Response";
}

template<>
struct has_fixed_size<rosidl_typesupport_introspection_tests::srv::Arrays_Response>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosidl_typesupport_introspection_tests::srv::Arrays_Response>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rosidl_typesupport_introspection_tests::srv::Arrays_Response>
  : std::true_type {};
...
template<>
inline const char * data_type<rosidl_typesupport_introspection_tests::srv::Arrays>()
{
  return "rosidl_typesupport_introspection_tests::srv::Arrays";
}

template<>
inline const char * name<rosidl_typesupport_introspection_tests::srv::Arrays>()
{
  return "rosidl_typesupport_introspection_tests/srv/Arrays";
}

template<>
struct has_fixed_size<rosidl_typesupport_introspection_tests::srv::Arrays>
  : std::integral_constant<
    bool,
    has_fixed_size<rosidl_typesupport_introspection_tests::srv::Arrays_Request>::value &&
    has_fixed_size<rosidl_typesupport_introspection_tests::srv::Arrays_Response>::value
  >
{
};

template<>
struct has_bounded_size<rosidl_typesupport_introspection_tests::srv::Arrays>
  : std::integral_constant<
    bool,
    has_bounded_size<rosidl_typesupport_introspection_tests::srv::Arrays_Request>::value &&
    has_bounded_size<rosidl_typesupport_introspection_tests::srv::Arrays_Response>::value
  >
{
};

template<>
struct is_service<rosidl_typesupport_introspection_tests::srv::Arrays>
  : std::true_type
{
};

template<>
struct is_service_request<rosidl_typesupport_introspection_tests::srv::Arrays_Request>
  : std::true_type
{
};

template<>
struct is_service_response<rosidl_typesupport_introspection_tests::srv::Arrays_Response>
  : std::true_type
{
};
...
#endif  // ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__SRV__DETAIL__ARRAYS__TRAITS_HPP_
