...
#ifndef ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__STRINGS__STRUCT_HPP_
#define ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__STRINGS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_typesupport_introspection_tests__msg__Strings __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_typesupport_introspection_tests__msg__Strings __declspec(deprecated)
#endif
...
struct Strings_
{
  ...
  // pointer types
  using RawPtr =
    rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_typesupport_introspection_tests__msg__Strings
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_typesupport_introspection_tests__msg__Strings
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::Strings_<ContainerAllocator> const>
...
using Strings =
  rosidl_typesupport_introspection_tests::msg::Strings_<std::allocator<void>>;
...
#endif  // ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__STRINGS__STRUCT_HPP_
