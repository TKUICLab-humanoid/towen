...
#ifndef ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
#define ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_typesupport_introspection_tests::msg::BasicTypes & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_typesupport_introspection_tests::msg::BasicTypes & msg)
{
  return rosidl_typesupport_introspection_tests::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_typesupport_introspection_tests::msg::BasicTypes>()
{
  return "rosidl_typesupport_introspection_tests::msg::BasicTypes";
}

template<>
inline const char * name<rosidl_typesupport_introspection_tests::msg::BasicTypes>()
{
  return "rosidl_typesupport_introspection_tests/msg/BasicTypes";
}

template<>
struct has_fixed_size<rosidl_typesupport_introspection_tests::msg::BasicTypes>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<rosidl_typesupport_introspection_tests::msg::BasicTypes>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<rosidl_typesupport_introspection_tests::msg::BasicTypes>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__BASIC_TYPES__TRAITS_HPP_
