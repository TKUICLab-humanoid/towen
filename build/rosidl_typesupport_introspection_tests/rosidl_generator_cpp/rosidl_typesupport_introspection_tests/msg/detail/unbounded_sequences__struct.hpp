...
#ifndef ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__UNBOUNDED_SEQUENCES__STRUCT_HPP_
#define ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__UNBOUNDED_SEQUENCES__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosidl_typesupport_introspection_tests__msg__UnboundedSequences __attribute__((deprecated))
#else
# define DEPRECATED__rosidl_typesupport_introspection_tests__msg__UnboundedSequences __declspec(deprecated)
#endif
...
struct UnboundedSequences_
{
  ...
  using _basic_types_values_type =
    std::vector<rosidl_typesupport_introspection_tests::msg::BasicTypes_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_introspection_tests::msg::BasicTypes_<ContainerAllocator>>>;
  _basic_types_values_type basic_types_values;
  using _constants_values_type =
    std::vector<rosidl_typesupport_introspection_tests::msg::Constants_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_introspection_tests::msg::Constants_<ContainerAllocator>>>;
  _constants_values_type constants_values;
  using _defaults_values_type =
    std::vector<rosidl_typesupport_introspection_tests::msg::Defaults_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_introspection_tests::msg::Defaults_<ContainerAllocator>>>;
  ...
  Type & set__basic_types_values(
    const std::vector<rosidl_typesupport_introspection_tests::msg::BasicTypes_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_introspection_tests::msg::BasicTypes_<ContainerAllocator>>> & _arg)
  {
    this->basic_types_values = _arg;
    return *this;
  }
  Type & set__constants_values(
    const std::vector<rosidl_typesupport_introspection_tests::msg::Constants_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_introspection_tests::msg::Constants_<ContainerAllocator>>> & _arg)
  {
    this->constants_values = _arg;
    return *this;
  }
  Type & set__defaults_values(
    const std::vector<rosidl_typesupport_introspection_tests::msg::Defaults_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_introspection_tests::msg::Defaults_<ContainerAllocator>>> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosidl_typesupport_introspection_tests__msg__UnboundedSequences
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosidl_typesupport_introspection_tests__msg__UnboundedSequences
    std::shared_ptr<rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<ContainerAllocator> const>
...
using UnboundedSequences =
  rosidl_typesupport_introspection_tests::msg::UnboundedSequences_<std::allocator<void>>;
...
#endif  // ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__UNBOUNDED_SEQUENCES__STRUCT_HPP_
