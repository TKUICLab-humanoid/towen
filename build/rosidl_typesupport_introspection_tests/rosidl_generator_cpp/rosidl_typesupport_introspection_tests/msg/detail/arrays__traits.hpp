...
#ifndef ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__ARRAYS__TRAITS_HPP_
#define ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__ARRAYS__TRAITS_HPP_
...
inline void to_yaml(
  const rosidl_typesupport_introspection_tests::msg::Arrays & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const rosidl_typesupport_introspection_tests::msg::Arrays & msg)
{
  return rosidl_typesupport_introspection_tests::msg::to_yaml(msg);
}

template<>
inline const char * data_type<rosidl_typesupport_introspection_tests::msg::Arrays>()
{
  return "rosidl_typesupport_introspection_tests::msg::Arrays";
}

template<>
inline const char * name<rosidl_typesupport_introspection_tests::msg::Arrays>()
{
  return "rosidl_typesupport_introspection_tests/msg/Arrays";
}

template<>
struct has_fixed_size<rosidl_typesupport_introspection_tests::msg::Arrays>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<rosidl_typesupport_introspection_tests::msg::Arrays>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<rosidl_typesupport_introspection_tests::msg::Arrays>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__MSG__DETAIL__ARRAYS__TRAITS_HPP_
