...
#ifndef ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__SRV__DETAIL__BASIC_TYPES__FUNCTIONS_H_
#define ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__SRV__DETAIL__BASIC_TYPES__FUNCTIONS_H_
 ...
 * calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Request__init().
...
/**
 * It calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Request__fini()
 ...
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosidl_typesupport_introspection_tests
...
/**
 * It calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosidl_typesupport_introspection_tests
...
/**
 * It allocates the memory for the array and calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosidl_typesupport_introspection_tests
...
/**
 * It calls
 * rosidl_typesupport_introspection_tests__srv__BasicTypes_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSIDL_TYPESUPPORT_INTROSPECTION_TESTS__SRV__DETAIL__BASIC_TYPES__FUNCTIONS_H_
