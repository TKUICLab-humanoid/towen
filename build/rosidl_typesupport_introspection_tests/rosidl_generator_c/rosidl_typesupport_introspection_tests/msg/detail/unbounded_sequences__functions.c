...
bool
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__init(rosidl_typesupport_introspection_tests__msg__UnboundedSequences * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__boolean__Sequence__init(&msg->bool_values, 0)) {
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // byte_values
  ...
  // basic_types_values
  if (!rosidl_typesupport_introspection_tests__msg__BasicTypes__Sequence__init(&msg->basic_types_values, 0)) {
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // constants_values
  if (!rosidl_typesupport_introspection_tests__msg__Constants__Sequence__init(&msg->constants_values, 0)) {
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // defaults_values
  if (!rosidl_typesupport_introspection_tests__msg__Defaults__Sequence__init(&msg->defaults_values, 0)) {
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(msg);
    return false;
  }
  // bool_values_default
...
void
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(rosidl_typesupport_introspection_tests__msg__UnboundedSequences * msg)
{
  if (!msg) {
    return;
  }
  ...
  // basic_types_values
  rosidl_typesupport_introspection_tests__msg__BasicTypes__Sequence__fini(&msg->basic_types_values);
  // constants_values
  rosidl_typesupport_introspection_tests__msg__Constants__Sequence__fini(&msg->constants_values);
  // defaults_values
  rosidl_typesupport_introspection_tests__msg__Defaults__Sequence__fini(&msg->defaults_values);
  // bool_values_default
  rosidl_runtime_c__boolean__Sequence__fini(&msg->bool_values_default);
  // byte_values_default
  rosidl_runtime_c__octet__Sequence__fini(&msg->byte_values_default);
...
bool
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__are_equal(const rosidl_typesupport_introspection_tests__msg__UnboundedSequences * lhs, const rosidl_typesupport_introspection_tests__msg__UnboundedSequences * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // basic_types_values
  if (!rosidl_typesupport_introspection_tests__msg__BasicTypes__Sequence__are_equal(
      &(lhs->basic_types_values), &(rhs->basic_types_values)))
  {
    return false;
  }
  // constants_values
  if (!rosidl_typesupport_introspection_tests__msg__Constants__Sequence__are_equal(
      &(lhs->constants_values), &(rhs->constants_values)))
  {
    return false;
  }
  // defaults_values
  if (!rosidl_typesupport_introspection_tests__msg__Defaults__Sequence__are_equal(
...
bool
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__copy(
  const rosidl_typesupport_introspection_tests__msg__UnboundedSequences * input,
  rosidl_typesupport_introspection_tests__msg__UnboundedSequences * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // basic_types_values
  if (!rosidl_typesupport_introspection_tests__msg__BasicTypes__Sequence__copy(
      &(input->basic_types_values), &(output->basic_types_values)))
  {
    return false;
  }
  // constants_values
  if (!rosidl_typesupport_introspection_tests__msg__Constants__Sequence__copy(
      &(input->constants_values), &(output->constants_values)))
  {
    return false;
  }
  // defaults_values
  if (!rosidl_typesupport_introspection_tests__msg__Defaults__Sequence__copy(
...
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_typesupport_introspection_tests__msg__UnboundedSequences * msg = (rosidl_typesupport_introspection_tests__msg__UnboundedSequences *)allocator.allocate(sizeof(rosidl_typesupport_introspection_tests__msg__UnboundedSequences), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_typesupport_introspection_tests__msg__UnboundedSequences));
  bool success = rosidl_typesupport_introspection_tests__msg__UnboundedSequences__init(msg);
  if (!success) {
...
void
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__destroy(rosidl_typesupport_introspection_tests__msg__UnboundedSequences * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(msg);
...
bool
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__init(rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_typesupport_introspection_tests__msg__UnboundedSequences * data = NULL;

  if (size) {
    data = (rosidl_typesupport_introspection_tests__msg__UnboundedSequences *)allocator.zero_allocate(size, sizeof(rosidl_typesupport_introspection_tests__msg__UnboundedSequences), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_typesupport_introspection_tests__msg__UnboundedSequences__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(&data[i - 1]);
      }
...
void
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__fini(rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(&array->data[i]);
    }
...
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence *
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * array = (rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence *)allocator.allocate(sizeof(rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__init(array, size);
  if (!success) {
...
void
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__destroy(rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__are_equal(const rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * lhs, const rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_typesupport_introspection_tests__msg__UnboundedSequences__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence__copy(
  const rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * input,
  rosidl_typesupport_introspection_tests__msg__UnboundedSequences__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_typesupport_introspection_tests__msg__UnboundedSequences);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_typesupport_introspection_tests__msg__UnboundedSequences * data =
      (rosidl_typesupport_introspection_tests__msg__UnboundedSequences *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_typesupport_introspection_tests__msg__UnboundedSequences__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_typesupport_introspection_tests__msg__UnboundedSequences__fini(&output->data[i]);
        }
        return false;
      }
    }
