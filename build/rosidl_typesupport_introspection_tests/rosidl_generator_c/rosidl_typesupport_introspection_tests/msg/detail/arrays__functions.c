...
bool
rosidl_typesupport_introspection_tests__msg__Arrays__init(rosidl_typesupport_introspection_tests__msg__Arrays * msg)
{
  if (!msg) {
    return false;
  }
  ...
  for (size_t i = 0; i < 3; ++i) {
    if (!rosidl_runtime_c__String__init(&msg->string_values[i])) {
      rosidl_typesupport_introspection_tests__msg__Arrays__fini(msg);
      return false;
    }
  }
  // basic_types_values
...
void
rosidl_typesupport_introspection_tests__msg__Arrays__fini(rosidl_typesupport_introspection_tests__msg__Arrays * msg)
{
  if (!msg) {
    return;
  }
...
bool
rosidl_typesupport_introspection_tests__msg__Arrays__are_equal(const rosidl_typesupport_introspection_tests__msg__Arrays * lhs, const rosidl_typesupport_introspection_tests__msg__Arrays * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
rosidl_typesupport_introspection_tests__msg__Arrays__copy(
  const rosidl_typesupport_introspection_tests__msg__Arrays * input,
  rosidl_typesupport_introspection_tests__msg__Arrays * output)
{
  if (!input || !output) {
    return false;
  }
...
rosidl_typesupport_introspection_tests__msg__Arrays__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_typesupport_introspection_tests__msg__Arrays * msg = (rosidl_typesupport_introspection_tests__msg__Arrays *)allocator.allocate(sizeof(rosidl_typesupport_introspection_tests__msg__Arrays), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rosidl_typesupport_introspection_tests__msg__Arrays));
  bool success = rosidl_typesupport_introspection_tests__msg__Arrays__init(msg);
  if (!success) {
...
void
rosidl_typesupport_introspection_tests__msg__Arrays__destroy(rosidl_typesupport_introspection_tests__msg__Arrays * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rosidl_typesupport_introspection_tests__msg__Arrays__fini(msg);
...
bool
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__init(rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_typesupport_introspection_tests__msg__Arrays * data = NULL;

  if (size) {
    data = (rosidl_typesupport_introspection_tests__msg__Arrays *)allocator.zero_allocate(size, sizeof(rosidl_typesupport_introspection_tests__msg__Arrays), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rosidl_typesupport_introspection_tests__msg__Arrays__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rosidl_typesupport_introspection_tests__msg__Arrays__fini(&data[i - 1]);
      }
...
void
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__fini(rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rosidl_typesupport_introspection_tests__msg__Arrays__fini(&array->data[i]);
    }
...
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence *
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * array = (rosidl_typesupport_introspection_tests__msg__Arrays__Sequence *)allocator.allocate(sizeof(rosidl_typesupport_introspection_tests__msg__Arrays__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__init(array, size);
  if (!success) {
...
void
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__destroy(rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__are_equal(const rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * lhs, const rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rosidl_typesupport_introspection_tests__msg__Arrays__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
rosidl_typesupport_introspection_tests__msg__Arrays__Sequence__copy(
  const rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * input,
  rosidl_typesupport_introspection_tests__msg__Arrays__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rosidl_typesupport_introspection_tests__msg__Arrays);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rosidl_typesupport_introspection_tests__msg__Arrays * data =
      (rosidl_typesupport_introspection_tests__msg__Arrays *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rosidl_typesupport_introspection_tests__msg__Arrays__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rosidl_typesupport_introspection_tests__msg__Arrays__fini(&output->data[i]);
        }
        return false;
      }
    }
