...
{
  new (message_memory) rosidl_typesupport_introspection_tests::msg::WStrings(_init);
}

void WStrings_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosidl_typesupport_introspection_tests::msg::WStrings *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember WStrings_message_member_array[7] = {
  {
    ...
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, wstring_value),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, wstring_value_default1),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, wstring_value_default2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, wstring_value_default3),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, array_of_wstrings),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, bounded_sequence_of_wstrings),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::WStrings, unbounded_sequence_of_wstrings),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers WStrings_message_members = {
  ...
  7,  // number of fields
  sizeof(rosidl_typesupport_introspection_tests::msg::WStrings),
...
get_message_type_support_handle<rosidl_typesupport_introspection_tests::msg::WStrings>()
{
  return &::rosidl_typesupport_introspection_tests::msg::rosidl_typesupport_introspection_cpp::WStrings_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosidl_typesupport_introspection_tests, msg, WStrings)() {
  return &::rosidl_typesupport_introspection_tests::msg::rosidl_typesupport_introspection_cpp::WStrings_message_type_support_handle;
}
