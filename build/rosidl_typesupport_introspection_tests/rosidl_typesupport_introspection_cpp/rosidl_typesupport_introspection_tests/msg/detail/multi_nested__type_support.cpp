...
{
  new (message_memory) rosidl_typesupport_introspection_tests::msg::MultiNested(_init);
}

void MultiNested_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosidl_typesupport_introspection_tests::msg::MultiNested *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<rosidl_typesupport_introspection_tests::msg::Arrays, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<rosidl_typesupport_introspection_tests::msg::Arrays, 3> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const rosidl_typesupport_introspection_tests::msg::Arrays *>(
    get_const_function__MultiNested__array_of_arrays(untyped_member, index));
  auto & value = *reinterpret_cast<rosidl_typesupport_introspection_tests::msg::Arrays *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<rosidl_typesupport_introspection_tests::msg::Arrays *>(
    get_function__MultiNested__array_of_arrays(untyped_member, index));
  const auto & value = *reinterpret_cast<const rosidl_typesupport_introspection_tests::msg::Arrays *>(untyped_value);
  item = value;
}
...
{
  const auto & member =
    *reinterpret_cast<const std::array<rosidl_typesupport_introspection_tests::msg::BoundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<rosidl_typesupport_introspection_tests::msg::BoundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__MultiNested__array_of_bounded_sequences(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rosidl_typesupport_introspection_tests::msg::BoundedSequences *>(
    get_const_function__MultiNested__array_of_bounded_sequences(untyped_member, index));
  auto & value = *reinterpret_cast<rosidl_typesupport_introspection_tests::msg::BoundedSequences *>(untyped_value);
  value = item;
}
...
void assign_function__MultiNested__array_of_bounded_sequences(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rosidl_typesupport_introspection_tests::msg::BoundedSequences *>(
    get_function__MultiNested__array_of_bounded_sequences(untyped_member, index));
  const auto & value = *reinterpret_cast<const rosidl_typesupport_introspection_tests::msg::BoundedSequences *>(untyped_value);
  item = value;
}
...
{
  const auto & member =
    *reinterpret_cast<const std::array<rosidl_typesupport_introspection_tests::msg::UnboundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<rosidl_typesupport_introspection_tests::msg::UnboundedSequences, 3> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__MultiNested__array_of_unbounded_sequences(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const rosidl_typesupport_introspection_tests::msg::UnboundedSequences *>(
    get_const_function__MultiNested__array_of_unbounded_sequences(untyped_member, index));
  auto & value = *reinterpret_cast<rosidl_typesupport_introspection_tests::msg::UnboundedSequences *>(untyped_value);
  value = item;
}
...
void assign_function__MultiNested__array_of_unbounded_sequences(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<rosidl_typesupport_introspection_tests::msg::UnboundedSequences *>(
    get_function__MultiNested__array_of_unbounded_sequences(untyped_member, index));
  const auto & value = *reinterpret_cast<const rosidl_typesupport_introspection_tests::msg::UnboundedSequences *>(untyped_value);
  item = value;
}

size_t size_function__MultiNested__bounded_sequence_of_arrays(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<rosidl_typesupport_introspection_tests::msg::Arrays> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosidl_typesupport_introspection_tests::msg::Arrays> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosidl_typesupport_introspection_tests::msg::Arrays> *>(untyped_member);
  return &member[index];
}
...
{
  const auto * member = reinterpret_cast<const std::vector<rosidl_typesupport_introspection_tests::msg::BoundedSequences> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosidl_typesupport_introspection_tests::msg::BoundedSequences> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosidl_typesupport_introspection_tests::msg::BoundedSequences> *>(untyped_member);
  return &member[index];
}
...
{
  const auto * member = reinterpret_cast<const std::vector<rosidl_typesupport_introspection_tests::msg::UnboundedSequences> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<rosidl_typesupport_introspection_tests::msg::UnboundedSequences> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<rosidl_typesupport_introspection_tests::msg::UnboundedSequences> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MultiNested_message_member_array[9] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosidl_typesupport_introspection_tests::msg::Arrays>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, array_of_arrays),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosidl_typesupport_introspection_tests::msg::BoundedSequences>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, array_of_bounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rosidl_typesupport_introspection_tests::msg::UnboundedSequences>(),  // members of sub message
    true,  // is array
    3,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, array_of_unbounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, bounded_sequence_of_arrays),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, bounded_sequence_of_bounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    true,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, bounded_sequence_of_unbounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, unbounded_sequence_of_arrays),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, unbounded_sequence_of_bounded_sequences),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosidl_typesupport_introspection_tests::msg::MultiNested, unbounded_sequence_of_unbounded_sequences),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MultiNested_message_members = {
  ...
  9,  // number of fields
  sizeof(rosidl_typesupport_introspection_tests::msg::MultiNested),
...
get_message_type_support_handle<rosidl_typesupport_introspection_tests::msg::MultiNested>()
{
  return &::rosidl_typesupport_introspection_tests::msg::rosidl_typesupport_introspection_cpp::MultiNested_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosidl_typesupport_introspection_tests, msg, MultiNested)() {
  return &::rosidl_typesupport_introspection_tests::msg::rosidl_typesupport_introspection_cpp::MultiNested_message_type_support_handle;
}
