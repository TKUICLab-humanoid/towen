...
{
  new (message_memory) rosidl_typesupport_introspection_tests::msg::Empty(_init);
}

void Empty_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosidl_typesupport_introspection_tests::msg::Empty *>(message_memory);
  typed_message->~Empty();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Empty_message_member_array[1] = {
  {
    ...
    offsetof(rosidl_typesupport_introspection_tests::msg::Empty, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Empty_message_members = {
  ...
  "Empty",  // message name
  1,  // number of fields
  sizeof(rosidl_typesupport_introspection_tests::msg::Empty),
...
get_message_type_support_handle<rosidl_typesupport_introspection_tests::msg::Empty>()
{
  return &::rosidl_typesupport_introspection_tests::msg::rosidl_typesupport_introspection_cpp::Empty_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosidl_typesupport_introspection_tests, msg, Empty)() {
  return &::rosidl_typesupport_introspection_tests::msg::rosidl_typesupport_introspection_cpp::Empty_message_type_support_handle;
}
