...
static const _IceServer_type_support_symbol_names_t _IceServer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, webrtc_ros_msgs, msg, IceServer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webrtc_ros_msgs, msg, IceServer)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, webrtc_ros_msgs, msg, IceServer)() {
  return &::webrtc_ros_msgs::msg::rosidl_typesupport_c::IceServer_message_type_support_handle;
}
